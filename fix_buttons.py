...
try:
    with open("app.py", "w", encoding="utf-8") as f:
        f.write(fixed_code)
    print("🎉 app.py 파일이 성공적으로 수정되었습니다!")
    print("✅ 삭제 버튼 상호 비활성화 문제가 해결되었습니다.")
    print("📁 백업 파일이 생성되었습니다.")
    print("\n이제 streamlit run app.py 로 앱을 다시 실행하세요.")
except Exception as e:
    print(f"❌ 파일 수정 실패: {e}")
    print(f"💡 백업 파일 {backup_name}에서 복구하세요.")
